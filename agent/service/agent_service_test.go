...
func Test_AgentService_Execute_WhenHealthCheckReturnsNotServing_ShouldUnregister_AndNotReturnError(t *testing.T) {
	// Arrange
	...
	// Act
	useCase := NewAgentService(rc, dc, hc, logrus.New())
	err := useCase.HandleService(svc)
...
func Test_AgentService_Execute_WhenReflectionClientCallFail_ShouldReturnError(t *testing.T) {
	// Arrange
	svc := entity.NewService("localhost:80", "fake", "id")
	implementedServicesFn := func(svc *entity.Service) ([]string, error) {
...
func Test_AgentService_HandleService_WhenDiscoveryClientRegisterServiceCallFail_ShouldReturnError(t *testing.T) {
	// Arrange
	svc := entity.NewService("localhost:80", "fake", "id")
	implementedServicesFn := func(svc *entity.Service) ([]string, error) {
		return []string{"fake1", "fake2"}, nil
...
func Test_AgentService_HandleService_WhenHealthCheckWatchCallFail_ShouldUnregister_AndNotReturnError(t *testing.T) {
	// Arrange
	svc := entity.NewService("localhost:80", "fake", "id")
	var unregistered bool = false
	implementedServicesFn := func(svc *entity.Service) ([]string, error) {
